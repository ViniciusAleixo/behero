...
export default function Detail() {
    ...
    const message = `Hello ${incident.name}, I'm getting in touch because I'd like to help with the case "${incident.title}" wit a value of ${Intl.NumberFormat('en-US', {style: 'currency', currency:'AUD'}).format(incident.value)}`
        ...
        <View style={styles.container}>
         ...
         <Text style={[styles.incidentProperty, { marginTop: 0}]}>ONG:</Text>
                    ...
                    <Text style={styles.incidentValue}>
                        ...
                        style: 'currency',
                         currency:'AUD'}).format(incident.value)}</Text>
         </View>
